...
@Deprecated('Use HTTPAdapter instead. This will be removed in 6.0.0')
typedef DefaultHttpClientAdapter = HTTPAdapter;

/// The signature of [HTTPAdapter.onHttpClientCreate].
...
/// The signature of [HTTPAdapter.createHttpClient].
/// Can be used to provide a custom [HttpClient] for Dio.
typedef CreateHttpClient = HttpClient Function();

/// The signature of [HTTPAdapter.validateCertificate].
typedef ValidateCertificate =
    bool Function(X509Certificate? certificate, String host, int port);

/// Creates an [HTTPAdapter].
HttpClientAdapter createAdapter() => HTTPAdapter();

/// FIXED AUTO LOWERCASE HEADER.
