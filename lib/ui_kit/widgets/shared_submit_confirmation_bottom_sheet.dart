...
class SharedSubmitConfirmationBottomSheet extends StatelessWidget {
  final VoidCallback onConfirm;
  final VoidCallback onCancel;
  final String? title;
  final String? description;

  const SharedSubmitConfirmationBottomSheet({
    super.key,
  ...
  static void show({
    ...
    showModalBottomSheet(
      ...
      builder: (context) => BackdropFilter(
        ...
        child: SafeArea(
          top: false,
          child: SharedSubmitConfirmationBottomSheet(
            onConfirm: onConfirm,
            onCancel: onCancel,
            title: title,
